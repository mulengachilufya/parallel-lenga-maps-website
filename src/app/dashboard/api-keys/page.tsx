      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            ...
            <h1 className="text-2xl font-black text-navy mb-2">API access comes with team plans</h1>
            <p className="text-gray-500 max-w-lg mx-auto mb-6 text-sm leading-relaxed">
              {eligReason === 'signin'        && "Sign in with a team account to mint API keys."}
              {eligReason === 'team_only'     && "The REST API is part of \"For Project Teams and Businesses\". Request a quote and we'll provision your team within a business day."}
              {eligReason === 'plan_inactive' && "Your team's plan isn't active right now. Email lengamaps@gmail.com to restore it."}
              {eligReason === 'error'         && "We couldn't verify your account just now. Refresh and try again."}
            </p>
            <Link href="/projects" className="inline-flex items-center gap-2 bg-accent text-navy text-sm font-bold px-5 py-2.5 rounded-lg hover:bg-yellow-400 transition-colors">
              About team plans
            </Link>
          </div>
        </div>
