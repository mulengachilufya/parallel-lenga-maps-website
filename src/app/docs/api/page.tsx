      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-32 pb-16">
        ...
        <Section icon={KeyRound} title="Authentication">
          <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            Available exclusively on <strong>For Project Teams and Businesses</strong> (team
            plans — <Link href="/projects" className="text-primary font-semibold hover:underline">get a quote</Link>).
            Individual plans don&apos;t carry API access. Send your key on every request:
          </p>
